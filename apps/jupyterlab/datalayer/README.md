...
![JupyterLab Datalayer](https://raw.githubusercontent.com/datalayer/datalayer/master/apps/jupyterlab/datalayer/docs/jupyterlab-datalayer.gif "JupyterLab Datalayer")
...
```bash
export DLA_TWITTER_OAUTH_CALLBACK_URL=http://localhost:8888/twitter/auth/popup
jupyter lab
```
