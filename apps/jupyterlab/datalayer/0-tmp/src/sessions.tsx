...
import {
  Twitter, TwitterBranchResult,TwitterStatusResult,TwitterShowTopLevelResult, TwitterAPI, TwitterLogResult
} from './connection'
 ...
 */
export
class TwitterSessions extends Widget {
   ...
   */
  constructor(app:JupyterLab, notebookTracker: INotebookTracker, options: TwitterSessions.IOptions, diff_function: any) {
    super({
      node: (options.renderer || TwitterSessions.defaultRenderer).createNode()
    });
...
//    this.component.refresh();
   ...
   */
  get renderer(): TwitterSessions.IRenderer {
...
//  private _manager: ServiceManager.IManager = null;
  private _renderer: TwitterSessions.IRenderer = null;
...
class TwitterSessionNode extends React.Component<TwitterSessionNode.IProps, TwitterSessionNode.IState>{
  ...
  render() {
    return(
      <TwitterAuth notebookTracker={this.props.notebookTracker}/>
    )
  }
