...
# Datalayer Solr Helm Chart

- https://solr.apache.org/guide/8_7/solrcloud-autoscaling.html
- https://solr.apache.org/guide/8_7/solrcloud-autoscaling-auto-add-replicas.html#the-autoaddreplicas-parameter
...
- https://www.youtube.com/watch?v=6uynE3-wyLU
- https://www.youtube.com/watch?v=UI9mh4gSIsw
- https://docs.portworx.com/portworx-install-with-kubernetes/application-install-with-kubernetes/solr
- https://www.eolya.fr/2020/01/06/kubernetes-deploiement-de-solrcloud

- https://medium.com/swlh/start-a-k8s-solrcloud-with-pre-installed-custom-libraries-customizing-solr-helm-chart-7dcb1d6ea57d
...
helm upgrade solr-operator apache-solr/solr-operator  --set-string ingressBaseDomain=ing.local.domain
kubectl get all
