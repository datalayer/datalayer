...
# Jupyterpool Experiments on Enterprise Gateway
...
```
BROWSER --- JUPYTER_SERVER --- ENTERPRISE_GATEWAY --- ORCHESTRATOR -- KERNEL                                
```
...
Download releases from https://github.com/jupyter/enterprise_gateway/releases.
