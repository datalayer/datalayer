...
PageConfig.setOption('notebookPath', '/hello-0.ipynb')

const notebookPanel = new BoxPanel();
notebookPanel.id = 'notebook-panel-id';
notebookPanel.direction = 'top-to-bottom';
notebookPanel.spacing = 0;
...
function createApp(manager: ServiceManager.IManager): void {
  ...
  panel.id = 'notebook-splitpanel-id';
...
//  Widget.attach(completer, document.body);
  notebookPanel.insertWidget(0, panel);
  notebookPanel.insertWidget(0, completer);
