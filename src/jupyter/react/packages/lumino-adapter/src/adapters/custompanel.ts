...
class CustomPanel extends Panel {
   ...
   */
  constructor(options: CustomPanel.IOptions = {}) {
   ...
   */
  get direction(): CustomPanel.Direction {
   ...
   */
  set direction(value: CustomPanel.Direction) {
   ...
   * entire box layout.
   */
  get alignment(): CustomPanel.Alignment {
   ...
   * entire box layout.
   */
  set alignment(value: CustomPanel.Alignment) {
...
/**
 * The namespace for the `CustomPanel` class statics.
 */
export
...
namespace Private {
   ...
   */
  export
  function createLayout(options: CustomPanel.IOptions): BoxLayout {
