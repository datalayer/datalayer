---
title: Visualization with Altair
---

#  Visualization with Altair

Altair [Docs](https://altair-viz.github.io).
Altair is built on [Vega](/visualization/vega.md).
...
- [Tableau-like in Python with Altair](https://maelfabien.github.io/machinelearning/Altair).
