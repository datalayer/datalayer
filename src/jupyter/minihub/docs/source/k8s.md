...
[Helm Chart Reference](https://zero-to-jupyterhub.readthedocs.io/en/latest/reference/reference.html).

[Minimalist Cheatsheets](https://minimalist-jupyterhub.readthedocs.io).

## Kube Spawner

Kube Spawner [GitHub](https://github.com/jupyterhub/kubespawner).

Kube Spawner [Docs](https://jupyterhub-kubespawner.readthedocs.io/en/latest/overview.html).
...
https://github.com/jupyterhub/kubespawner/issues/163
https://github.com/jupyterhub/zero-to-jupyterhub-k8s/issues/710

https://github.com/jupyterhub/kubespawner/pull/406
https://github.com/jupyterhub/zero-to-jupyterhub-k8s/pull/1673
https://github.com/jupyterhub/zero-to-jupyterhub-k8s/issues/1642  
...
[Turn off user storage](https://zero-to-jupyterhub.readthedocs.io/en/latest/customizing/user-storage.html#turn-off-per-user-persistent-storage).
...
```bash
# Option 1: Deploy from jupyterhub Helm repository.
helm install \
...
- https://github.com/cbell/generic-eks-jupyterhub

## JupyterHub on AKS

- https://zero-to-jupyterhub.readthedocs.io/en/latest/microsoft/step-zero-azure.html
- https://zero-to-jupyterhub.readthedocs.io/en/latest/microsoft/step-zero-azure-autoscale.html

## JupyterHub on Open Stack
...
- https://github.com/pangeo-data/terraform-deploy/tree/blog-post
...
- https://github.com/jupyterhub/z2jh-cluster
