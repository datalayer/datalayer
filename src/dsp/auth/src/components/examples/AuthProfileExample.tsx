...
export function AuthProfileExample(props) {
  React.useEffect(() => {
    window.scrollTo(0, 0);
            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={12} md={6}>
                <div className={classes.profile}>
                  <div>
                    <img src={christian} className={imageClasses} />
                  </div>
...
export default withStyles(styles as any, {index: 999, classNamePrefix: 'DlaAuthProfileExample'})(AuthProfileExample);
