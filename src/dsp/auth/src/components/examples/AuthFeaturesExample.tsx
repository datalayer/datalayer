...
import { featuresStyle } from "dspWidgets/Widgets";
import { img_bg9 as bgTipi } from "dspWidgets/Widgets";

const useStyles = makeStyles(featuresStyle as any, {index: 1, classNamePrefix: 'DlaAuthFeaturesExample' });

function AuthFeaturesExample({ ...rest }) {
