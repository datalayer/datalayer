...
const useStyles = makeStyles(styles as any, {index: -1, classNamePrefix: 'DlaLandingTmpExample' });

export function LandingW1Example({ ...rest }) {
...
export default LandingW1Example;
