...
import '../styles/CodeBlock.module.scss'
...
export default class CodeBlock extends React.Component<ICodeBlockProps, ICodeBlockState> {
  ...
  public render() {
    ...
    let toggleButton;
    if (isCollapsible) {
      toggleButton = <button className={ "toggle" } onClick={ this._onToggleClicked.bind(this) }>&lt;/&gt;</button>;
    }
    ...
    return (
      <div className={ css(
        ...
        isOpen ? "isOpen" : '',
        isLightTheme ? ".isLightTheme" : "isDarkTheme"
      ) }>
        { toggleButton }
        <div className={ "code" }>
