...
sudo su
cd
curl https://raw.githubusercontent.com/datalayer/api/kuber-master/_specs/aws/kuber-aws-master -o $DLAHOME/bin/kuber-aws-master
...
sudo su
cd
curl https://raw.githubusercontent.com/datalayer/api/kuber-master/_specs/aws/kuber-aws-join -o $DLAHOME/bin/kuber-aws-join 
