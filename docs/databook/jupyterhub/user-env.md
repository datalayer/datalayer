...
Read more about the [User Environment](https://jupyterhub.readthedocs.io/en/stable/reference/config-user-env.html).

## Named Servers

Users can add [Named Servers](https://jupyterhub.readthedocs.io/en/stable/reference/config-user-env.html#named-servers) via `/hub/home` URL.
...
![Named Servers](https://jupyterhub.readthedocs.io/en/stable/_images/named-servers-home1.png)

## User Servers Administration

Administrators can Administrate the Users' Servers via `/hub/admin` URL.

![Users' Servers Administration](https://jupyterhub.readthedocs.io/en/stable/_images/named-servers-admin.png)
