...
> :sparkles: :mega: Documentation for Datalayer Science Platform. :lollipop:

The content of this folder is deployed on the Datalayer Science Platform documentation [website](https://docs.datalayer.io).
