...
```bash
jupyter notebook --port 8888 --NotebookApp.token=test-secret --NotebookApp.allow_origin='https://thebelab.readthedocs.io'
open https://thebelab.readthedocs.io/en/latest/_static/local.html
```
