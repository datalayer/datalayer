...
Upon the User URLs, JupyterHub also exposes [API URLs](/jupyterhub/api.md).
...
[Separated](https://jupyterhub.readthedocs.io/en/latest/reference/separate-proxy.html) Proxy.

## Custom Proxy

Writing a [custom Proxy](https://jupyterhub.readthedocs.io/en/stable/reference/proxy.html) implementation.
...
Read more on [using Reverse Proxy](https://jupyterhub.readthedocs.io/en/stable/reference/config-proxy.html).
